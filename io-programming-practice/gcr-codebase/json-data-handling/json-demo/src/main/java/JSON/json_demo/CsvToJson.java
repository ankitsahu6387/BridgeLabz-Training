...
public class CsvToJson {
	...
	public static void main(String[] args) {
		try {
            File csvFile = new File("D:\\BridgeLabz-Training\\io-programming-practice\\gcr-codebase\\json-data-handling\\json-demo\\src\\main\\java\\JSON\\json_demo\\student.csv");
